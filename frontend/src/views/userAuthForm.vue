<template>
  <div class="flex items-center justify-center h-screen gap-24">
    ...
    <div class="flex flex-col items-center gap-4 mr-12">
      ...
      <div class="border-t h-5 w-96 border-rose-600"></div>
      ...
      <div class="grid w-full max-w-sm items-center gap-1.5">
        <form class="w-96 space-y-6" @submit="onSubmit">
          ...
          <div class="flex flex-col">
            <Toaster />
            <div class="flex">
              <Button type="submit" class="bg-rose-500 w-32 text-white mr-5"> Войти </Button>
...
<style scoped>
.bg-image {
  background-image: url('../img/d58a19684826f08ff64e858283051909.jpg');
