          ...
          <div class="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              ...
              >
                ...
                <div class="mt-2">
                  <p class="text-sm font-golos text-gray-500">
                    {{ doctorStore.doctorPersonalOnline.fullName }}
                  </p>
                </div>
                <div class="mt-2">
                  <p class="text-sm font-golos text-gray-500">
                    {{ doctorStore.doctorPersonalOnline.specializations[0].nameSpecialization }}
                  </p>
                </div>
                <div class="mt-2">
                  <p class="text-sm font-golos text-gray-500">
...
const scheduleData = ref(doctorStore.doctorPersonalOnline.schedule)
