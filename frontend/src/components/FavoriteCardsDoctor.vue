<template>
  <div
    class="flex items-center border-gray-300 border-[1px] rounded-[8px] pr-4 sm:pr-6 lg:pr-8 mt-4"
  >
    <Avatar class="h-[72px] w-[72px] sm:h-[100px] sm:w-[100px] lg:h-[120px] lg:w-[120px] ml-6">
    ...
    <div class="flex flex-col mt-4 sm:mt-6 lg:mt-[32px] ml-4 sm:ml-6 lg:ml-[20px]">
      <div class="flex gap-2">
        <span
          v-for="specialization in specializationDoctor"
          :key="specialization.id"
          class="font-golos text-gray-400"
      ...
      <Button
        class="text-sm sm:text-base leading-5 sm:leading-6 font-light font-golos w-[450px] h-[36px] sm:h-[40px] lg:h-[44px] mb-3 sm:mb-4 lg:mb-[13px]"
        variant="outline"
      >
        Записаться на прием
      </Button>
...
const specializationDoctor = ref([
  {
    id: 1,
    name: 'Терапевт,',
  },
